#+TITLE: Chai (拆) - Destructive Reading and Knowledge Digestion
#+AUTHOR: Yibie
...
2. *Refinery* — "Fork" content into a workbench for deep processing and refinement

#+begin_quote
📖 Read → 🔧 Dismantle → ✨ Internalize
#+end_quote
...
└── refinery.org      ;; Refinery workbench
#+end_example
...
#+begin_example
┌─────────────┐      ┌─────────────┐      ┌─────────────┐      ┌─────────────┐
│   Source    │ ──▶ │    Fork     │ ──▶ │   Process   │ ──▶ │    Save     │
│  (Library)  │      │ (Refinery)  │      │ (Compress/  │      │ (Permanent  │
│             │      │             │      │  Rewrite)   │      │   Note)     │
└─────────────┘      └─────────────┘      └─────────────┘      └─────────────┘
#+end_example
...
| =C-c x= | Export highlights (copy/refinery/note) |
...
rendered automatically in any Org buffer containing chai links — no need to
...
4. *Dismantle* — Navigate to a heading you want to excerpt, =M-x chai-refine-heading=
5. *Process* — Rewrite and compress content in Refinery
6. *Save* — =C-c C-c= to save as permanent note
...
- *Org-roam* — Save Refinery notes to Org-roam directory
